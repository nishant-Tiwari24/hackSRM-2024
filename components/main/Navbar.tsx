...
const Navbar = () => {
  return (
    ...
    <div className='w-[500px] h-[55px] flex flex-row items-start justify-between md:mr-20'>
        <div className='flex flex-row items-center justify-between border border-[#7042f861] mr-[15px] px-[20px] py-[10px] rounded-full text-green-500 gap-[100px]'>
